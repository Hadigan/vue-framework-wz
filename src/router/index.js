...
export const asyncRouterMap = [
    ...
    {
        path: '/home1',
        redirect: '/home1/video',
        name: '首页2',
        component: Full2,
        hidden: false,
        children: [
            {
                path: '/home1/video', name: '视频', redirect: '/charts/shopchart', icon: 'pie-graph',
                component: { render(c) { return c('router-view') } },
                children: [
                    { path: 'videoCheck', name: '伪造视频鉴别', icon: 'arrow-graph-up-right', component: _import('myview/video/VideoCheck') },
                    { path: 'faceGeneration', name: '伪造人脸生成', icon: 'stats-bars', component: _import('myview/video/FaceGeneration'), hidden: false, },
                    { path: 'videoGeneration', name: '伪造视频生成', icon: 'ios-analytics', component: _import('myview/video/VideoGeneration') }
                ]
            },
            {
                path: '/home1/voice', name: '语音', redirect: '/charts/shopchart', icon: 'pie-graph',
                component: { render(c) { return c('router-view') } },
                children: [
                    { path: 'radarchart', name: '伪造语音鉴别', icon: 'arrow-graph-up-right', component: _import('charts/RadarChart') },
                    { path: 'shopchart', name: '伪造语音生成', icon: 'stats-bars', component: _import('charts/ShopChart'), hidden: false, },
                ]
            },
            {
                path: '/home1/watermark', name: '数字水印', redirect: '/charts/shopchart', icon: 'pie-graph',
                component: { render(c) { return c('router-view') } },
                children: [
                    { path: 'radarchart', name: '水印提取', icon: 'arrow-graph-up-right', component: _import('charts/RadarChart') },
                    { path: 'shopchart', name: '水印嵌入', icon: 'stats-bars', component: _import('charts/ShopChart'), hidden: false, },
                ]
            },
            {
                path: '/home1/analyze', name: '音视频检测分析', redirect: '/charts/shopchart', icon: 'pie-graph',
                component: { render(c) { return c('router-view') } },
                children: [
                    { path: 'radarchart', name: '水印提取', icon: 'arrow-graph-up-right', component: _import('charts/RadarChart') },
                    { path: 'shopchart', name: '水印嵌入', icon: 'stats-bars', component: _import('charts/ShopChart'), hidden: false, },
